...
public class v0_2_X_Changes {
    ...
    public static void add_v0_2_2_Changes( ArrayList<ChangeInfo> changeInfos ){
        ...
        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SANDBAG, null), "Pixel Dungeon v1.7.2",
        ...
        changes.addButton( new ChangeButton(new Image(Assets.ARCS_BG, 112, 112, 16, 16), "New Plants",
    ...
    public static void add_v0_2_1_Changes( ArrayList<ChangeInfo> changeInfos ){
        ...
        changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.REMAINS, null), "Story & Signpost Changes",
