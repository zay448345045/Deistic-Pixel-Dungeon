...
public class Bomb extends Item {
	...
	public ArrayList<String> actions(Hero hero) {
		...
		if (Dungeon.hero.subRace()==HeroSubRace.DEMOLITIONIST && Dungeon.hero.lvl>4){
		  actions.add(AC_DIZZYBOMB);
		} 
         if (Dungeon.hero.subRace()==HeroSubRace.DEMOLITIONIST && Dungeon.hero.lvl>9){
		  actions.add(AC_SMARTBOMB);
		}
         if (Dungeon.hero.subRace()==HeroSubRace.DEMOLITIONIST && Dungeon.hero.lvl>14){
		  actions.add(AC_SEEKINGBOMB);
		}
         if (Dungeon.hero.subRace()==HeroSubRace.DEMOLITIONIST && Dungeon.hero.lvl>19){
		  actions.add(AC_CLUSTERBOMB);
		}
          if (Dungeon.hero.subRace()==HeroSubRace.DEMOLITIONIST && Dungeon.hero.lvl>29){
